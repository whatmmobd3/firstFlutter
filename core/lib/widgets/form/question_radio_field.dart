...
import 'radio_items_view.dart';
import 'textbox_field.dart';

/// Field to select one value from a list of Radio Widgets
class QuestionRadioField<T> extends FormBuilderField<T> {
  ...
  QuestionRadioField(
      ...
      : super(
          ...
          builder: (FormFieldState<T?> field) {
            final state = field as _QuestionRadioFieldState<T>;
            return Column(
              children: [
                if (questionMsg != null)
                  Container(
  ...
  @override
  _QuestionRadioFieldState<T> createState() => _QuestionRadioFieldState<T>();
}

class _QuestionRadioFieldState<T>
    extends FormBuilderFieldState<QuestionRadioField<T>, T> {}
