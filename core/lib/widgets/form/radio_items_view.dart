...
class RadioItemsView<T> extends StatefulWidget {
  ...
  @override
  _RadioItemsViewState<T> createState() => _RadioItemsViewState<T>();
}

class _RadioItemsViewState<T> extends State<RadioItemsView<T?>> {
  @override
